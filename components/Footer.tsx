  ...
  return (
    <footer className="bg-dark-brown text-white">
      <div className="container mx-auto px-4 py-16 pb-48">
        <div className="grid grid-cols-5">
          ...
          <div className="flex flex-col items-end col-span-2">
            <div className="flex justify-center gap-20 mb-14 whitespace-nowrap">
              <div className="space-y-10">
                <a href="tel:+48123072877" className="block text-2xl">
                  +48 12 307 28 77
                </a>
                <a href="tel:+48692933069" className="block text-2xl">
                  +48 692 933 069
                </a>
              </div>
              <div className="space-y-10">
      ...
      <div className="border-t border-white/20 text-white/60">
        <div className="container mx-auto flex items-center px-4 py-4 text-sm gap-20">
